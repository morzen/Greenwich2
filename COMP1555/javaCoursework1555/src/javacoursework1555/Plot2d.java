...
/*
I just want to make cleat that i do not own the code below i found it during my research it come from 
this web site https://rosettacode.org/wiki/Plot_coordinate_pairs#Java
and only needed minor modification to make it work at the time i am writting this i only modify line 73 74  76 77 and 89 
if there is major modification done i hope it will be visible and if not i wanna make clear and sure that 
this code doesn't belong to me and i do not intend to plagirise 
